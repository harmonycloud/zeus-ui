...
export default class MidTerminal extends React.Component {
	constructor(props) {
		super(props);
		this.timer = null;
	}
	...
	openInitTerminal = () => {
		...
		this.timer = setTimeout(() => {
			// fetch(this.props.url, { method: 'POST' }).then((res) => {
			...
			// 	});
			// });
			socket = new WebSocket(socketURL, cache.getLocal('token'));
